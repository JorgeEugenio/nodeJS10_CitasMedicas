		...
		<div class="p-col-12">
			<div>
				...
				<DataTable ref="dt" :value="clientes" v-model:selection="selectedClientes" dataKey="_id" :paginator="true" :rows="15" :filters="filters"
                    ...
                    <Column field="correoCliente" header="Correo" :sortable="true"></Column>
                    <Column field="fechaCreacionCliente" header="Fecha creacion" :sortable="true"></Column>
                    <Column field="direccionCliente.departamento" header="Departamento" :sortable="true"></Column>
                    <Column field="direccionCliente.provincia" header="Provincia" :sortable="true"></Column>
                    <Column field="direccionCliente.distrito" header="Distrito" :sortable="true"></Column>
					...
					<Column field="nombreCuentaPago" header="nombreCuentaPago" :sortable="true"></Column>
					<Column field="numeroCuentaPago" header="numeroCuentaPago" :sortable="true"></Column>
...
<!-- 					<div class="p-field">
						<label for="idTorre">Cliente</label>
						<Dropdown id="idTorre" v-model="clientesDetalle.idTorre" :options="torresResumido" optionLabel="text" optionValue="value" placeholder="Select One" required="true" :class="{'p-invalid': submitted && !clientesDetalle.idTorre}"></Dropdown>
					</div> -->
					<template #footer>
				...
				<Dialog v-model:visible="deleteClienteDialog" :style="{width: '450px'}" header="Confirm" :modal="true">
					<div class="confirmation-content">
						...
						<span v-if="cliente">Are you sure you want to delete <b>{{cliente.nameSector}}</b>?</span>
					</div>
					<template #footer>
