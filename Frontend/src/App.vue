            ...
            menu : [
				...
				},
				{
					...
					items: [
                        ...
                        {label: 'Clientes detalle', icon: 'pi pi-fw pi-user', to: '/clientedetalle'},
                        {label: 'Edición', icon: 'pi pi-fw pi-circle-off',to: '/edicion'},
                        {label: 'Boletas', icon: 'pi pi-fw pi-circle-off',to: '/resumen'},
                        {label: 'Ingles', icon: 'pi pi-fw pi-github',to: '/ingles'}  
					]
				},
                {
